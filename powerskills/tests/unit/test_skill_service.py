...
from powerskills.core.services.skill import SkillService
from powerskills.core.models import SkillCreate, PlatformType, Pricing
...
class TestSkillService:
    ...
    async def test_create_skill(self):
        ...
        with patch.object(service, '_parse_skill') as mock_parse:
            ...
            with patch('powerskills.core.services.skill.seekdb_client') as mock_db:
